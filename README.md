...
- TODO: ER will remember what you said to him in the past (RAG)
...
It uses OpenAI API to answer questions (TODO: but can be plugged in to your local LLM server)
...
How to run:
```python
python ./src/real_voice_faster.py 
```
